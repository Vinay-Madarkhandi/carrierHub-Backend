...
export const validateBookingCreation = [
  body('consultantType')
    .isIn(['CAREER_GUIDANCE', 'COLLEGE_COURSE', 'EXAM_PREPARATION', 'STUDY_ABROAD', 'SKILL_MENTORSHIP', 'JOB_PLACEMENT', 'GOVERNMENT_JOBS', 'PERSONAL_GROWTH', 'ALTERNATIVE_CAREERS'])
  ...
  body('amount')
    .isInt({ min: parseInt(process.env.MIN_BOOKING_AMOUNT) || 10000 })
    .withMessage(`Amount must be at least ${(parseInt(process.env.MIN_BOOKING_AMOUNT) || 10000) / 100} INR`),
  handleValidationErrors
];
